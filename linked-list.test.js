...
describe("setAt", function() {
  it("sets val at index", function() {
    ...
    expect(lst.setAt(1, 1));
    expect(lst.setAt(2, 2));
...
describe("insertAt", function() {
  it("inserts node and adjusts nearby nodes", function() {
    ...
    expect(lst.head.val).toBe(5);
    //This is wrong, the index in this case doesn't start from zero, starts at 1
    expect(lst.head.next.val).toBe(12);
...
describe("removeAt", function() {
  it("removes from 1-item list", function() {
    ...
    lst.removeAt(1);
    //The same case in here the linked list starts at index 1, not 0.
    expect(lst.length).toBe(0);
    expect(lst.head).toBe(null);
    expect(lst.tail).toBe(null);
  });
